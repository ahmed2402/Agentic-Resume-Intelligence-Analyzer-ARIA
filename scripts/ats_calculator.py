...
Usage: python scripts/ats_calculator.py <resume_path> [job_description_path]
"""
...
from agents.ats_agent import ATSAnalyzer, create_ats_score_circle
from core.utils import load_job_description

def main():
    if len(sys.argv) < 2:
        print("Usage: python scripts/ats_calculator.py <resume_path> [job_description_path]")
        print("Example: python scripts/ats_calculator.py data/raw/resumes/resume.pdf data/raw/job_descriptions/job.txt")
        sys.exit(1)
